      ...
      <div className="vdm-admin2" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 28 }}>
        <section>
          ...
          <div className="vdm-card" style={{ padding: 20 }}>
            <p style={{ fontSize: 13, color: '#7a7873', marginBottom: 12 }}>Upload a CSV with columns: Name, Company, Phone, Email, Event, Sub-event, Category, Cleanup status, Id, Country, Source, Registration Date.</p>
            <input
              ref={importInputRef}
              type="file"
              accept=".csv"
