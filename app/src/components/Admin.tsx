      ...
      <div className="vdm-admin2" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 28 }}>
        <section>
          ...
          <div className="vdm-card" style={{ padding: 20 }}>
            <p style={{ fontSize: 13, color: '#7a7873', marginBottom: 12 }}>CSV with a header row. Recognised columns (any order): Name, Company, Phone Code, Phone, Email, Event, Sub-event, Category, Cleanup status, Id, Country, Source, Registration Date. Phone Code is combined with Phone automatically.</p>
            <input
              ref={importInputRef}
              type="file"
              accept=".csv"
